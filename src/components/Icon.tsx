...
const PATHS = {
  ...
  mark: "M5 8.5 9 4.5h6l4 4v7l-4 4H9l-4-4zM9.5 10.5v3M14.5 10.5v3",
  flame: "M12 3c.6 3 3.2 4.2 3.2 7a3.2 3.2 0 0 1-6.4 0c0-.9.3-1.6.7-2.2M12 21a6 6 0 0 1-6-6c0-3.4 2.4-5 3.4-7.6",
  sparkle: "M12 3.5 13.7 9l5.3 1.7-5.3 1.7L12 18l-1.7-5.6L5 10.7 10.3 9zM18.5 15.5l.7 2 2 .7-2 .7-.7 2-.7-2-2-.7 2-.7z",
  calendar: "M4.5 7.5h15v13h-15zM4.5 11.5h15M8.5 4v4M15.5 4v4",
  heart: "M12 20.5s-7.5-4.5-7.5-9.6A4.2 4.2 0 0 1 12 8.2a4.2 4.2 0 0 1 7.5 2.7c0 5.1-7.5 9.6-7.5 9.6Z",
  comment: "M4.5 5.5h15v11h-9L6 20.5v-4H4.5z",
